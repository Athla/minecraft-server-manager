...
import { Upload, Settings, HardDrive, Folder, Power, PowerOff, Play, LogOut } from 'lucide-react';
import { toast } from '@/hooks/use-toast';
import { logout } from '@/lib/api'; // Import the logout API function
...
const ServerCreator: React.FC<ServerCreatorProps> = ({ onLogout }) => {
	...
	return (
		<div className="max-h-screen bg-gradient-to-b from-slate-900 to-slate-800 p-6">
			<div className="max-w-5xl mx-auto space-y-8">
				<div className="flex flex-col items-center space-y-4">
					...
					<Button
						...
						className="minecraft-button bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 flex items-center gap-2"
					>
